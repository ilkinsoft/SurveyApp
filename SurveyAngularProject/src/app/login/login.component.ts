...
export class LoginComponent implements OnInit {
  ...
  constructor(private notificationService:NotificationService, private router:Router,private toastr: ToastrService,private formBuilder: FormBuilder,private myHttpService:MyHttpServiceService) {
  ...
  onSubmit(): void {
    ...
    this.myHttpService.post('users/login',this.loginForm.value).subscribe((result: any) =>{
      ...
      if(result.code === 'SUCCESS'){
        ...
        this.notificationService.loginOrLogoutSuccess();
